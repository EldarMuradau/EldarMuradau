...
- Physics. I worked on custom physics engine, PhysX/NvBlast and PhysX-based engines, dynamic physical animations (active ragdolls that is used in replays, highlights system, gameplay movement, humanoid physical contest, combat and shooter systems etc), destruction physics with real-time fracturing, ragdolls, physically-based combat system, resimulations, vehicles, physics optimizations, multi-threaded simulations, network sync, patching PhysX etc. 
